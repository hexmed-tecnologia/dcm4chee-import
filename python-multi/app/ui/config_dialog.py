...
class ConfigDialog(tk.Toplevel):
    def __init__(self, master, config: AppConfig, on_save, on_test_echo):
        ...
        self.lbl_dcm4che_mode.grid(row=6, column=0, sticky="w", pady=3)
        ...
        self.cmb_dcm4che_mode.grid(row=6, column=1, sticky="we", pady=3)
        ...
        self.lbl_dcm4che_iuid_mode.grid(row=7, column=0, sticky="w", pady=3)
    ...
    def _build_config(self) -> AppConfig:
        ...
        return AppConfig(
            ...
            batch_size_default=int(self._base_config.batch_size_default),
